...
public interface SmoolaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SmoolaParser#program1}.
	 * @param ctx the parse tree
	 */
	void enterProgram1(SmoolaParser.Program1Context ctx);
	/**
	 * Exit a parse tree produced by {@link SmoolaParser#program1}.
	 * @param ctx the parse tree
	 */
	void exitProgram1(SmoolaParser.Program1Context ctx);
	/**
